...
import (
	...
	"github.com/hasegawa-tomoki/scheduler/task"
)

const TestTaskName = "github.com/hasegawa-tomoki/scheduler/task.(*CallbackMock).CallNoArgs-fm"
...
func TestPopulateTasks(t *testing.T) {
	...
	taskAttributes := storage.TaskAttributes{
		...
		Duration:    "5s",
		IsRecurring: "0",
		Name:        "github.com/hasegawa-tomoki/scheduler/task.(*CallbackMock).CallNoArgs-fm",
		Params:      "",
	}
